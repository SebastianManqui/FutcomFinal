...
Para proteger la integridad de los datos y optimizar la comunicación, se han implementado DTOs (Data Transfer Objects) en una capa independiente, evitando que las entidades de persistencia se expongan directamente en los controladores.
